        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-800 tracking-tight leading-[1.05] mt-3">
              Explorez nos
              <br />
              <span className="text-[#1a6b3c]">univers.</span>
            </h2>
          </motion.div>
          ...
          >
            Tout voir <FiArrowRight className="w-4 h-4" aria-hidden="true" />
          </Link>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  ...
                  <h3 className="text-white font-black text-lg leading-tight">{col.name}</h3>
                  <div className="flex items-center gap-1 text-[#4ade80] text-xs font-bold mt-2 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                    Découvrir <FiArrowRight className="w-3 h-3" aria-hidden="true" />
                  </div>
                </div>
              </Link>
            </motion.div>
