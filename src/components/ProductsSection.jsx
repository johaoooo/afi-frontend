      ...
      <div className="container-custom">
        ...
        {bestSeller && (
          <div className="mb-12 bg-gradient-to-r from-green-50 to-yellow-50 dark:from-green-900/20 dark:to-yellow-900/20 rounded-2xl p-6 border-2 border-green-200 dark:border-green-800 hover:border-yellow-400 dark:hover:border-yellow-600 transition-all duration-300">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-green-600 dark:text-green-400 font-semibold text-sm">⭐ Collection Afisac</span>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Le sac Afisac le plus populaire</p>
              </div>
        ...
        {featuredProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 dark:text-gray-400">Aucun produit Afisac disponible pour le moment.</p>
            <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">Découvrez bientôt notre collection de sacs macramé.</p>
          </div>
        )}
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-xs mt-3">Collection de sacs macramé Afisac</p>
        </div>
      </div>
    </section>
  );
