...
const ContactPage = () => {
  ...
  const socialLinks = [
    { icon: FaFacebook, name: 'Facebook', url: 'https://facebook.com/aficollection', color: 'bg-blue-600', hoverColor: 'hover:bg-blue-700' },
    { icon: FaInstagram, name: 'Instagram', url: 'https://instagram.com/aficollection', color: 'bg-pink-600', hoverColor: 'hover:bg-pink-700' },
    { icon: FaTwitter, name: 'Twitter', url: 'https://twitter.com/aficollection', color: 'bg-sky-500', hoverColor: 'hover:bg-sky-600' },
    { icon: FaWhatsapp, name: 'WhatsApp', url: 'https://wa.me/22999999999', color: 'bg-green-500', hoverColor: 'hover:bg-green-600' },
    { icon: FaTiktok, name: 'TikTok', url: 'https://tiktok.com/@aficollection', color: 'bg-black', hoverColor: 'hover:bg-gray-800' },
    { icon: FaLinkedin, name: 'LinkedIn', url: 'https://linkedin.com/company/aficollection', color: 'bg-blue-700', hoverColor: 'hover:bg-blue-800' },
  ];
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {socialLinks.map((social, idx) => (
                  <a
                    ...
                    className={`w-10 h-10 ${social.color} ${social.hoverColor} rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-md`}
                    title={social.name}
                  >
